...
(defconstant $rrl-files
  '(
    "art" "defvars" "franz" "datamacs" "miscel" 

    "operators" "term" "subst" "match" "acdio" "acunify"

    "input" "syntax" "output" "options" "history" 
    ...
    "xtree" "xprover" "xrrl" "xmanual" "initialize" 
    ))
...
;;(format t "Eschbach Mon Jan 20 12:58:48 MET 1997~%")	
...
(lrrl) 
(format t "Eschbach Fri Jan 17 15:01:10 MET 1997~%")
;;(crrl)
